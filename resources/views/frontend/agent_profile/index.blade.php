                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="search-match">
                            ...
                            <form method="post" action="" enctype="multipart/form-data" id="agent_search_form">
                                @csrf
                                <ul class="select-gender">
                                    <li class="selected">
                                        <input type="radio" value="M"  id="gender_m" name="gender" hidden> <img id="male_profile" src="{{asset('/')}}public/frontend/images/male.png" alt="">
                                    </li>
                                    <li>
                                        <input type="radio" value="F" id="gender_f" name="gender" hidden><img id="female_profile" src="{{asset('/')}}public/frontend/images/female.png" alt="">
                                    </li>
                                </ul>
...
{{--                                            <div id="price-range" class="slider"></div>--}}
                        ...
                        <div class="load-more">
                            <div class="central-meta">
                                <div class="row merged20 agent-profile-data remove-ext">
...
<script>
    ...
    function searchAgentData() {
        let _reder = $(".agent-profile-data");
    ...
    $("#agent_search_form").submit(function(e) {
        e.preventDefault();
        searchAgentData();
    });
