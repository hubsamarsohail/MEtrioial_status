                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="featured-baner mate-black ext-low-opacity" id="opacity">
                            <div class="sub-links">
                                ...
                                <a class="btn btn-secondary" style="float:right;" href="{{route('userProfile')}}">Create Profile</a>
                            </div>
...
{{--                                            <input type="range" class="slider" oninput="sliderChange(this.value)" value="" max="100" min="0" step="5" name="end_age" >--}}
                                          ...
                                          <div class="col-sm-12">
                                              <div style="color: black;text-align: center;">
                                                  <div id="profile_all" class="box">
                                                      <span id="five" > <div style="word-spacing: 2px;">(Past 7 days)</div>  <br> <div style="display: ruby-text-container;"><b><a href="{{route('prodile.log.past')}}" style="color: blue; font-size: 24px;">{{$profile_logs->count()}} </a></b>Profile Viewers </b> <b> </b></div> </span>
                                                  </div>
                                              </div>
                                          </div>
                                      </div>
