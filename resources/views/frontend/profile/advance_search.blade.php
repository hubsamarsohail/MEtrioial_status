                                        ...
                                        <div class="widget">
                                            ...
                                            <form  method="post"   action="" class="c-form search"  id="advance_search_form"  >
                                             ...
                                             <div>
												...
												<input type="text" name="cast"  id="cast" placeholder="Enter Cast" >
											</div>
											...
											<div class="col-sm-12" style="padding:0px">
                                                ...
                                                <div class="row">
													<div class="col-md-6" style >
														<select name="feet"   id="feet" class="mb-2 form-control">
													...
													<div class="col-md-6"  >
														<select name="inch" id="inch"  class="mb-2 form-control">
                                            ...
                                            <div>
												...
												<select class="mb-2 form-control" id="religion" name="religion" >
											...
											<div>
												...
												<select class="mb-2 form-control" id="ethnicity" name="ethnicity" >
											...
											<div>
												...
												<select class="mb-2 form-control" id="body_shape" name="body_shape">
											...
											<div>
													...
													<div class="form-radio">
														<span class="radio">
															<label>
																<input type="radio" name="drink_status" value="1" class="drink_status"  id="drink_status" name="radio" ><i class="check-box"></i>Yes
															</label>
														</span>
														<span class="radio">
															<label>
																<input type="radio" name="drink_status" value="0" class="drink_status" id="drink_status" name="radio"><i class="check-box"></i>No
															</label>
                                                        </span>
													</div>
											</div>
											<div>
												...
												<div class="form-radio">
													<div class="radio">
														<label>
															<input type="radio"  name="smoke_status" class="smoke_status" id="smoke_status" value="1"><i class="check-box"></i>Yes
														</label>
													</div>
													<div class="radio">
														<label>
															<input type="radio" name="smoke_status" class="smoke_status" id="smoke_status" value="0" ><i class="check-box"></i>No
														</label>
													</div>
												</div>
											</div>
											...
											<div>
												...
												<select class="mb-2 form-control"  id="mother_lang" name="mother_lang" >
											...
											<div>
                                                ...
                                                <div class="radio">
														<label>
															<input type="radio" value="{{$key}}" id="marital_status" class="marital_status"  name="marital_status" ><i class="check-box"></i>{{$value}}
														</label>
													</div>
                                                    <option ></option>
                                                    @endforeach
...
<script>
    ...
    $("#ethnicity").change(function(e) {
        ...
        data["ethnicity"] = $(this).val();
        advanceSearch(data);
    });


    $("#body_shape").change(function(e) {
        e.preventDefault();
        var data = new Array();
        data["cast"] = $('#cast').val();
        data["feet"] = $('#feet').val();
        ...
        data["body_shape"] = $(this).val();
        advanceSearch(data);
    });
    $("#mother_lang").change(function(e) {
        e.preventDefault();
        var data = new Array();
        data["cast"] = $('#cast').val();
        data["feet"] = $('#feet').val();
        ...
        data["religion"] = $('#religion').val();
        data["ethnicity"] = $('#ethnicity').val();
        data["body_shape"] = $('#body_shape').val();
        data["mother_lang"] = $(this).val();
        advanceSearch(data);
    });
    $(".smoke_status").change(function(e) {
        e.preventDefault();
        ...
        data["ethnicity"] = $('#ethnicity').val();
        data["body_shape"] = $('#body_shape').val();
        data["mother_lang"] = $('#mother_lang').val();
        data["smoke_status"] = $(this).val();
        advanceSearch(data);
    });

    $(".drink_status").change(function(e) {
        e.preventDefault();
        $(this).attr('checked', true);
        var data = new Array();
        data["cast"] = $('#cast').val();
        ...
        data["body_shape"] = $('#body_shape').val();
        data["mother_lang"] = $('#mother_lang').val();
        data["smoke_status"] = $('#smoke_status').val();
        data["drink_status"] = $(this).val();
        advanceSearch(data);
    });
    ...
    $(".marital_status").change(function(e) {
        ...
        data["mother_lang"] = $('#mother_lang').val();
        data["smoke_status"] = $('#smoke_status').val();
        data["drink_status"] = $('#drink_status').val();
        data["marital_status"] = $(this).val();
        advanceSearch(data);
    });
