							...
							<div class="row">
								<div class="col-lg-12">
									<div class="pitpoint-filter central-meta">
										...
										<ul class="view-port">
											<li class="active">
                                                <a href="#" title=""><i class="fa fa-th"></i></a></li>
...
{{--                                        <span class="create-post">Suggested Friend's <a href="{{route('user.suggestion')}}" title="">See All</a></span>--}}
{{--                                        <ul class="suggested-frnd-caro" >--}}
{{--                                            @if(!empty($uProfiles))--}}
{{--                                                @foreach($uProfiles as $profile)--}}
{{--                                                    <li  >--}}
{{--                                                        <img style="width: 186px;height: 186px;"  src="{{asset('public/uploads/profile').'/'.$profile->email.'/'.$profile->image_path }}" alt="">--}}
{{--                                                        <div class="sugtd-frnd-meta">--}}
{{--                                                            <a href="{{route('udetails',Hashids::encode($profile->user_profile_id))}}" title="">{{$profile->users->first_name}}</a>--}}
{{--                                                            <span style="color: #0b0b0b">1 mutual friend</span>--}}
