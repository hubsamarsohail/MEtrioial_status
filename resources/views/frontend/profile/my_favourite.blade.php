...
{{--                                    <a class="main-btn2" href="#" title="">Follow</a>--}}
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="pitpoint-filter central-meta" style=" background: #012070a8 none repeat scroll 0 0;">
                                    <ul class="view-port">
                                        <li><a href="{{route('uProfileDetail')}}" title=""><i class="fa fa-th"></i></a></li>
                                    </ul>
                        ...
                        @foreach($usersuggestions->profileFavourite as $usersuggest)
                        ...
                        <div class="load-more">
                            ...
                            <div class="central-meta item">
                                <div class="pit-post">
                                    ...
                                    <figure>
                                        <a href="{{route('udetails',Hashids::encode($usersuggest->user_profile_id))}}" title="">
                                        <img style="height:150px; width: 200px" src="{{asset('public/uploads/profile').'/'.$usersuggest->email.'/'.$usersuggest->image_path }} " alt="">
                                    </a>  </figure>

                                    <div class="pit-post-deta">
                                        <h4><a href="{{route('udetails',Hashids::encode($usersuggest->user_profile_id))}}" title=""><span class="status f-online"></span> @if($usersuggest->user_name[0]){{$usersuggest->user_name[0]}} @endif | {{$usersuggest->age}}</a></h4>
                                        <ul class="post-up-time">
                                            ...
                                            <li><i class="fa fa-map-marker"></i> {{$usersuggest->nationality}}</li>
                                        </ul>

                                        <ul class="pit-opt">
                                            <li>
                                                <div class="likes heart" title="Cast"><span>{{$usersuggest->cast}}</span></div>
                                            </li>
                                            <li class="smile-it" title="Send Message"><i class="fa fa-message"></i><em>Send Message</em>
                                                <div class="smiles-bunch">
                                                    <i class="em em---1"></i>
                                                    <i class="em em-smiley"></i>
                                                    <i class="em em-anguished"></i>
                                   ...
                                   <a href="javascript:void(0)" > <i style="font-size:24px; color: black;
float: right" onclick="removefavourite({{$usersuggest->user_profile_id}})" class="fa">&#xf00d;</i></a>
                                </div>
                            </div>
                        </div>
                        @endforeach
