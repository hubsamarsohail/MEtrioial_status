                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                                        <div class="user-log">
                                                            ...
                                                            <a href="#" title=""><img style="height: 100px; width: 90px; margin-bottom: 10px" id="img_src"  src="{{asset('public/uploads/profile').'/'.$userProfile->email.'/'.$userProfile->image_path }}" alt="">
                                        ...
                                        <div class="tab-pane active" role="tabpanel" id="step1">
                                            <div class="container-fluid" style="padding-right: 30px; padding-left: 30px;" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="text" value="{{$userProfile->sur_name}}" class="form-control required"  id="middle_name" name="sur_name" placeholder="Enter Middle Name">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="text" class="pf required" name="cast" value="{{$userProfile->cast}}" placeholder="Enter Cast">
                                                    </div>
                                                    <input type='hidden' name ="user_id" value="{{session()->get('user_web_data')['user_info']['web_user_id']}}" >
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input class="mb-2 pf pfh required" type="date" value="{{$userProfile->dob}}" id="birthday" name="dob">
                                                    </div>

                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="number" class="required form-control" value="{{$userProfile->age}}"  pattern="[0-9]*" name="age"   placeholder="Enter Age">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        ...
                                                        <select class="form-control required"  name="religion">
                                                            ...
                                                            @foreach(array_flip($religions) as $key => $value)
                                                                ...
                                                                <option value="{{$key}}" {{ $userProfile->religion == $key ? 'selected' : '' }} >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="text" class="pf required" name="nationality" value="{{$userProfile->nationality}}" placeholder="Enter Nationality">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <select class="form-control required"   id="country_id"  name="country_id">
                                                            ...
                                                            @foreach($countries as $country)
                                                                <option value="{{$country->country_id}}"  @php if( $userProfile->country_id == $country->country_id ){ echo "selected"; } @endphp >{{$country->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required"  id="city_id"  name="city_id">
                                                            ...
                                                            <option value="1" @php if( $userProfile->city_id == '1' ){ echo "selected"; } @endphp>Multan</option>
                                                            <option value="2" @php if( $userProfile->city_id == '2' ){ echo "selected"; } @endphp>Islamabad</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" id="work_city" name="work_city">
                                                            ...
                                                            <option value="1" @php if( $userProfile->work_city == '1' ){ echo "selected"; } @endphp>Karachi</option>
                                                            <option value="2" @php if( $userProfile->work_city == '2' ){ echo "selected"; } @endphp>Lahore</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input class="mb-2 pf pfh required" type="number" value="{{$userProfile->mobile}}" placeholder="Enter Mobile Number" name="mobile" id="numb">
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" id="residential_city"  name="residential_city">
                                                            ...
                                                            <option value="1" @php if( $userProfile->residential_city == '1' ){ echo "selected"; } @endphp >Karachi</option>
                                                            <option value="2" @php if( $userProfile->residential_city == '2' ){ echo "selected"; } @endphp >Sialkot</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="text" class="pf required" value="{{$userProfile->hair_color}}" name="hair_color" placeholder="Enter Hair Color">
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="eye_color" class="form-control">
                                                            ...
                                                            @foreach(array_flip($eyescolors) as $key => $value)
                                                                <option value="{{$key}}" @php if( $userProfile->eye_color == $key ){ echo "selected"; } @endphp > {{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        @foreach(array_flip($complexions) as $key => $value)
                                                            <option value="{{$key}}" @php if( $userProfile->complexion == $key ){ echo "selected"; } @endphp>{{$value}}</option>
                                                            @endforeach
                                                            </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="body_shape" class="form-control">
                                                            ...
                                                            @foreach(array_flip($body_shapes) as $key => $value)
                                                                <option value="{{$key}}" @php if( $userProfile->body_shape == $key ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                @php
                                                                    $inc = 0;
                                                                   $feet  = 0;
                                                                   $inc =   ceil($userProfile->height/ 2.54);
                                                                   $feet =   round($inc/12);
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="ethnicity" class="form-control">
                                                            ...
                                                            @foreach(array_flip($ethnicities) as $key => $value)
                                                                <option value="{{$key}}" @php if( $userProfile->ethnicity == $key ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                   ...
                                                   <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="skin_color" class="form-control">
                                                            ...
                                                            @foreach(array_flip($skincolors) as $key => $value)
                                                                ...
                                                                <option value="{{$key}}"  @php if( $userProfile->skin_color == $key ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="marital_status">
                                                            ...
                                                            @foreach(array_flip($marital_status) as $key => $value)
                                                                ...
                                                                <option value="{{$key}}"  @php if( $userProfile->marital_status == $key ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="mother_lang">
                                                            ...
                                                            @foreach(array_flip($languages) as $key => $value)
                                                                ...
                                                                <option value="{{$key}}" @php if( $userProfile->mother_lang == $key ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="other_lang" >
                                                            ...
                                                            @foreach(array_flip($languages) as $key => $value)
                                                                <option value="{{$key}}" @php if( $userProfile->other_lang == $key ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="physique_id" >
                                                            ...
                                                            @foreach(array_flip($physiques) as $key => $value)
                                                                ...
                                                                <option value="{{$key}}" @php if( $userProfile->physique_id == $key ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="life_style" >
                                                            ...
                                                            @foreach(array_flip($life_styles) as $key => $value)
                                                                ...
                                                                <option value="{{$key}}" @php if( $userProfile->life_style == $key ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label style="float: right" for=""><span style="float: right; color: red;">*</span>
                                                            <small></small></label>
                                                        <input type="number" name="no_of_children" value="{{$userProfile->no_of_children}}" class="pf " placeholder="Enter Number Of Childrens">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label for="">Ages of Child</label><span style="float: right; color: red;">*</span>
                                                        <input type="number" class="pf " value="{{$userProfile->child_age}}"  name="child_age" placeholder="Ages of Child">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required" name="salary_range" >
                                                            ...
                                                            @foreach(array_flip($salarys) as $key => $value)
                                                                ...
                                                                <option value="{{$key}}" @php if( $userProfile->salary_range == $key ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="gender mb-2">
                                                            ...
                                                            <div class="form-radio">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="drink_status" {{ $userProfile->drink_status == '1' ? 'checked' : '' }} value="1" ><i class="check-box"></i>Yes
                                                                    </label>
                                                                </div>
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="drink_status" {{ $userProfile->drink_status == '0' ? 'checked' : '' }} value="0"><i class="check-box"></i>No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="gender mb-2">
                                                            ...
                                                            <div class="form-radio">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="smoke_status" {{ $userProfile->smoke_status == '1' ? 'checked' : '' }} value="1" ><i class="check-box"></i>Yes
                                                                    </label>
                                                                </div>
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="smoke_status" {{ $userProfile->smoke_status == '0' ? 'checked' : '' }} value="0"><i class="check-box"></i>No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="gender mb-2">
                                                            ...
                                                            <div class="form-radio">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="pet_status" value="1" {{ $userProfile->pet_status == '1' ? 'checked' : '' }} ><i class="check-box"></i>Yes
                                                                    </label>
                                                                </div>
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="pet_status" {{ $userProfile->pet_status == '0' ? 'checked' : '' }} value="0"><i class="check-box"></i>No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="gender mb-2">
                                                            ...
                                                            <div class="form-radio">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="chat" value="1" {{ $userProfile->chat == '1' ? 'checked' : '' }} ><i class="check-box"></i>Yes/OK
                                                                    </label>
                                                                </div>
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="chat" {{ $userProfile->chat == '0' ? 'checked' : '' }} value="0"><i class="check-box"></i>No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="gender mb-2">
                                                            ...
                                                            <div class="form-radio">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="phone_cell" {{ $userProfile->phone_cell == '1' ? 'checked' : '' }} value="1" checked="checked"><i class="check-box"></i>Yes/OK
                                                                    </label>
                                                                </div>
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="phone_cell" {{ $userProfile->phone_cell == '0' ? 'checked' : '' }} value="0"><i class="check-box"></i>No
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="permission" role="tabpanel" aria-labelledby="permission-tabs">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="text" class="pf" value="{{$userProfile->profession}}" name="profession" placeholder="Enter Profession">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="text" class="pf" value="{{$userProfile->job_title}}" name="job_title" placeholder="Enter Job Title">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="text" class="pf" value="{{$userProfile->skill}}" name="skill" placeholder="Enter Skill">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                                    <div class="col-md-12"><span style="float: right; color: red;">*</span>
                                                        <textarea class="pf" rows="4" value="" name="description" placeholder="Order Note"> {{$userProfile->description}}</textarea>
                                                    </div>
                                                </div>
                                                <br>
                                            </div>
...
{{--                                            <div class="tab-pane fade" id="permission2" role="tabpanel" aria-labelledby="permission-tabs2">--}}
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="text" class="pf" value="{{$userProfile->elementry_school}}" name="elementry_school" placeholder="Enter Elementary Schools Name">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input type="text" class="pf" value="{{$userProfile->heigh_school}}" name="heigh_school" placeholder="Enter High School Name">
                                                    </div>
                                                    <div class="col-md-4" style="margin-top: 2%">
                                                        <label for="" style="float: right; color: red;" ></label>
                                                        <input type="text" class="pf"  value="{{$userProfile->bachelor_school}}" name="bachelor_school" placeholder="Enter Bachelors Degree Name">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="" style="float: right; color: red;"></label>
                                                        <input type="text" class="pf" value="{{$userProfile->master_school}}" name="master_school" placeholder="Enter Master Degree Name">
                                                    </div>

                                                    <div class="col-md-4">
                                                        <label for="" style="float: right; color: red;"></label>
                                                        <input type="text" class="pf" value="{{$userProfile->docor_degree}}" name="docor_degree" placeholder="Enter Doctor's Degree">
                                                    </div>

                                                    <div class="col-md-4">
                                                        <label for="" style="float: right; color: red;"></label>
                                                        <input type="text" class="pf" value="{{$userProfile->university}}" name="university" placeholder="Enter University Education Name">
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="partner_alcohol" value="1" {{ $userProfile->partner_alcohol == '1' ? 'checked' : '' }}  ><i class="check-box"></i>Yes
                                                                        </label>
                                                                    </div>
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="partner_alcohol" {{ $userProfile->partner_alcohol == '0' ? 'checked' : '' }}  value="0"><i class="check-box"></i>No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="second_marriage" {{ $userProfile->second_marriage == '1' ? 'checked' : '' }} value="1" checked="checked"><i class="check-box"></i>Yes
                                                                        </label>
                                                                    </div>
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="second_marriage" {{ $userProfile->second_marriage == '0' ? 'checked' : '' }} value="0"><i class="check-box"></i>No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="partner_smoke" {{ $userProfile->partner_smoke == '1' ? 'checked' : '' }} value="1" ><i class="check-box"></i>Yes
                                                                        </label>
                                                                    </div>
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="partner_smoke" {{ $userProfile->partner_smoke == '0' ? 'checked' : '' }}  value="0"><i class="check-box"></i>No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-radio">
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="partner_divorce" value="1" {{ $userProfile->partner_divorce == '1' ? 'checked' : '' }}  ><i class="check-box"></i>Yes
                                                                        </label>
                                                                    </div>
                                                                    <div class="radio">
                                                                        <label>
                                                                            <input type="radio" name="partner_divorce" value="0" {{ $userProfile->partner_divorce == '0' ? 'checked' : '' }}  ><i class="check-box"></i>No
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="user-log">
                                                                ...
                                                                @if(isset($userProfile))
                                                                    <a href="#" title=""><img
                                                                            ...
                                                                            id="img_src_agent"
                                                                            src="{{asset('public/uploads/profile').'/'.$userProfile->email.'/'.$userProfile->image_path }}"
                                                                            alt="">
                                                                    </a>
                                                                @else
                                                                    <a href="#" title=""><img
                                            ...
                                            <div class="container-fluid" style="padding-right: 30px; padding-left: 30px;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" class="form-control required agent_switch"
                                                               id="middle_name"
                                                               value="{{isset($userProfile) ? $userProfile->sur_name : '' }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="number" class="required form-control agent_switch"
                                                               value="{{isset($userProfile) ? $userProfile->age : '' }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required agent_switch" name="religion">
                                                            ...
                                                            @foreach(array_flip($religions) as $key => $value)
                                                                ...
                                                                <option
                                                                    value="{{$key}} " @php if( isset($userProfile) ? $userProfile->religion == $key : '' ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="text" class="pf form-control required agent_switch"
                                                               name="nationality"
                                                               value="{{isset($userProfile) ? $userProfile->nationality : '' }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required agent_switch" id="country_id"
                                                            ...
                                                            @foreach($countries as $country)
                                                                <option
                                                                    value="{{$country->country_id}}" @php if( isset($userProfile) ? $userProfile->country_id == $country->country_id : '' ){ echo "selected"; } @endphp >{{$country->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required agent_switch" id="city_id"
                                                            ...
                                                            <option
                                                                value="1" @php if( isset($userProfile) ? $userProfile->city_id == '1' : '' ){ echo "selected"; } @endphp >
                                                                Multan
                                                            </option>
                                                            <option
                                                                value="2" @php if( isset($userProfile) ? $userProfile->city_id == '2' : '' ){ echo "selected"; } @endphp >
                                                                Islamabad
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required agent_switch" id="work_city"
                                                            ...
                                                            <option
                                                                value="1" @php if( isset($userProfile) ? $userProfile->work_city == '1' : '' ){ echo "selected"; } @endphp >
                                                                Karachi
                                                            </option>
                                                            <option
                                                                value="2" @php if( isset($userProfile) ? $userProfile->work_city == '2' : '' ){ echo "selected"; } @endphp >
                                                                Lahore
                                                            </option>
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="mb-2 pf form-control required agent_switch"
                                                               type="number"
                                                               value="{{isset($userProfile) ? $userProfile->mobile : '' }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required agent_switch"
                                                            ...
                                                            <option
                                                                value="1" @php if( isset($userProfile) ? $userProfile->residential_city == '1' : '' ){ echo "selected"; } @endphp >
                                                                Karachi
                                                            </option>
                                                            <option
                                                                value="2" @php if( isset($userProfile) ? $userProfile->residential_city == '2' : '' ){ echo "selected"; } @endphp >
                                                                Sialkot
                                                            </option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required agent_switch"
                                                            ...
                                                            @foreach(array_flip($languages) as $key => $value)
                                                                ...
                                                                <option
                                                                    value="{{$key}}" @php if( isset($userProfile) ? $userProfile->mother_lang == $key : '' ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required agent_switch" name="ethnicity"
                                                            ...
                                                            @foreach(array_flip($ethnicities) as $key => $value)
                                                                <option
                                                                    value="{{$key}}" @php if( isset($userProfile) ? $userProfile->ethnicity == $key : '' ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-control required agent_switch"
                                                            ...
                                                            @foreach(array_flip($languages) as $key => $value)
                                                                <option
                                                                    value="{{$key}}" @php if( isset($userProfile) ? $userProfile->other_lang == $key : '' ){ echo "selected"; } @endphp >{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input class="mb-2 pf pfh form-control required agent_switch"
                                                               value="{{isset($userProfile) ? $userProfile->education : '' }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input class="mb-2 pf pfh form-control required agent_switch"
                                                               value="{{isset($userProfile) ? $userProfile->job_title : '' }}"
                                                    ...
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input class="mb-2 pf pfh form-control required agent_switch"
                                                               value="{{isset($userProfile) ? $userProfile->skill : '' }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input class="mb-2 pf pfh form-control required agent_switch"
                                                               value="{{isset($userProfile) ? $userProfile->business_turnour : '' }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="" style="float: right; color: red;">*</label>
                                                        <input class="mb-2 pf pfh form-control required agent_switch"
                                                               value="{{isset($userProfile) ? $userProfile->address : '' }}"
                                                        ...
                                                        <div class="gender mb-2">
                                                            ...
                                                            <div class="form-radio">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="chat"
                                                                               {{$userProfile->chat == '1' ? 'checked' : '' }} value="1"><i
                                                                ...
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="chat"
                                                                               {{$userProfile->chat == '0' ? 'checked' : '' }}  value="0"><i
                                                                ...
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="phone_cell"
                                                                               {{$userProfile->phone_cell == '1' ? 'checked' : '' }} value="1"><i
                                                                            class="check-box"></i>Yes/OK
                                                                    </label>
                                                                </div>
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="phone_cell"
                                                                               {{$userProfile->phone_cell == '0' ? 'checked' : '' }}  value="0"><i
                                                                            class="check-box"></i>No
                                                                    </label>
                                                                </div>
                                                            </div>
