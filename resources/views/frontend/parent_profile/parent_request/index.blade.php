                                    ...
                                    <div class="central-meta item">
                                        <div class="pit-post">
                                            ...
                                            <div class="pit-post-deta">
                                                <h4><a href="{{route('udetails',Hashids::encode($requestparent->parentRequest->user_profile_id))}}" title=""><span class="status f-online"></span> {{$requestparent->parentusers->first_name}} | {{$requestparent->parentRequest->age}}</a></h4>
...
{{--                                                <a href="#" title="" class="main-btn" data-ripple="">Reject</a>--}}
