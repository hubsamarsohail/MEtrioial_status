...
<!--    <link rel="icon" href="{{asset('/')}}public/frontend/images/fav.png" type="image/png" sizes="16x16"> -->
    ...
    #top-line {
                ...
                background-image: url({{asset('/')}}public/images/Laptop-Header.png);
                        ...
                        <div class="featured-baner mate-black ext-low-opacity" id="opacity">
                            <div class="sub-links">
                                <div class="heart-pnts">
                                    ...
                                    <a title="" href="#">Suggestion Profile</a>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="search-match">
                            ...
                            <form method="post" action="" enctype="multipart/form-data" id="suggestion_search_form">
                                @csrf
                                ...
                                <div class="chk">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" value="0" name="profile" checked="checked"><i class="check-box"></i>with photo
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" value="0" name="profile_wout" checked="checked"><i class="check-box"></i>without photo
                                        </label>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" value="0" name="profile_video" checked="checked"><i class="check-box"></i>with video
                                        </label>
                                    </div>
                                </div>
                                <div class="oth-opt" style="width: 17%">
                                    <div class="loc">
                                        <label>Cast:</label>
                            ...
                            <p></p>
                            <a class="main-btn2" style="float:right;" href="{{route('advance.search')}}">  <i class="fa fa-search"></i> Advance Search</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-9">
                                ...
                                <div class="pitpoint-filter central-meta">
                                    ...
                                    <div class="range-slider">
                                        <div class="slider-box">
                                            ...
                                            {{--												<input type="range" class="slider" oninput="sliderChange(this.value)" max="100" min="0" step="5" name="end_age" >--}}
                        ...
                        <div class="load-more">
                            <div class="central-meta">
                                <div class="row merged20 suggestion-profile-data remove-ext">
...
<script>
    ...
    function searchSuggestionData() {
        let _reder = $(".suggestion-profile-data");
        ...
        $.ajax({
            ...
            type: "Post",
            url: '{{ route("suggestion.search") }}',
            data: $("#suggestion_search_form").serialize(),
            cache: false,
    ...
    $("#suggestion_search_form").submit(function(e) {
        e.preventDefault();
        searchSuggestionData();
    });
