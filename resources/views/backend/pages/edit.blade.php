                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" id="quickForm" method="POST" enctype="multipart/form-data" action="{{route('aPagesU')}}">
                                @csrf
                                <input type="hidden" name="page_id" value="{{$page->page_id}}"  hidden >
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="title">Title:*</label>
                                        <input type="text" name="title" value="{{$page->title}}" class="form-control" id="service-title"
                                               autocomplete="off"
                                   ...
                                   @foreach($page->Pages_image as $img)
                                    <img height="80px; width:80px; margin: 90px" src="{{asset('public/uploads/Pages').'/'.$page['page_id'].'/'.$img['image_path']}}" >
                                    @endforeach
                                    <div class="clone hide" style="display: none">
                                        <div class="control-group input-group"
                                             style="margin-top:10px">
                                            <input type="file" id="attachments" style="height:0.5%;" name="attachments[]"
                                                   class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"  rows="4" id="editor" placeholder="Enter the Description" name="description">{{$page->body}}</textarea><div>
                                        </div>
                                    </div>
