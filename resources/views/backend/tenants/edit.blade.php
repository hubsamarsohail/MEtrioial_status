...
@section('title') Tenants | Edit @endsection
@section('page_css_js')
    <!-- Select2 -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form role="form" id="quickForm" method="post"
                                  action="{{route('aTenantU', ['tenant_id' => encrypt($tenant->tenant_id)])}}"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name"
                                               placeholder="Tenant Name" required value="{{$tenant->name}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Email:*</label>
                                        <input type="text" name="email" class="form-control" id="email"
                                               placeholder="Tenant Email" required value="{{$tenant->email}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="phone">Phone:*</label>
                                        <input type="text" name="phone" class="form-control" id="phone"
                                               placeholder="Tenant Phone" required value="{{$tenant->phone}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="address">Address:*</label>
                                        <input type="text" name="address" class="form-control" id="address"
                                               placeholder="Tenant Address" required value="{{$tenant->address}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4" name="is_active" style="width: 100%;"
                                            ...
                                            @foreach($isActive as $k => $v)
                                                <option value="{{ $v }}" {{$tenant->is_active == $v ? 'selected' : ''}}>{{ $k }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
