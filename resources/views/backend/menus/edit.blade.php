...
@section('title') Menus | Edit @endsection
@section('page_css_js')
    <!-- Select2 -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Edit Menu <small>Detail</small>
                                </h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" id="quickForm" method="post" action="{{route('aMenuU', ['menu_id' => $request->menu_id])}}">
                                @csrf
                                <div class="card-body">
