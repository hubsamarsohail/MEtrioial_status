                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Edit CMS <small>Detail</small>
                                </h3>
                            </div>
                            <div>
{{--                                {{dd($cms_data)}}--}}
                                <form role="form" id="quickForm" method="POST" action="{{route('aCMSU',['cms_id'=> encrypt($cms_data['cms_id'])])}}">
                                    @csrf
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group" id="slider_description">
                                                <label>Image Slider Description:*</label>
                                                {{--                                        <input type="text" name="titles[]" class="form-control" id="filesID"--}}
                                                {{--                                               autocomplete="off" multiple="multiple" onchange="encodeBase64multi(this)"--}}
                                                {{--                                               placeholder="Image Slider Titles">--}}
                                            </div>
